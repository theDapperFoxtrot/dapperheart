export const SK = "dh-v7";

export const def = () => ({
	name: "", ancestry1: "", ancestry2: "", ancestryFeat1: "first", ancestryFeat2: "second", community: "", pronouns: "", className: "", subclass: "", multiclass: "", level: 1,
	...
	inv: [], notes: "", bgA: ["", "", ""], conA: ["", "", ""], tierOpts: { 2: [], 3: [], 4: [] }, tierDetails: { 2: {}, 3: {}, 4: {} }, loadout: [], vault: [],
	charDesc: { clothes: "", eyes: "", body: "", skin: "", attitude: "" }, inspiration: 0,
	portrait: "", refImages: [], journal: [], noteImages: {}, advHistory: [], beastform: null, activeEffects: []
});
